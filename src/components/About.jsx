  ...
  return (
    <section className="relative py-24 bg-white px-6 lg:px-32" id="about">
      <div className="mx-auto text-center">
        ...
        </br> In addition to crafts, we also provide natural agricultural goods like dried Eucheuma cottonii seaweed and premium rice husks, supporting sustainable practices in food, farming, and wellness. Our mission is to empower communities through products that reflect the values of tradition, nature, and quality.
        </p>
      </div>
    </section>
  );
